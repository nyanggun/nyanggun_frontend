                        ...
                        <div className="card-setting align-items-center gap-1">
                            <div className="card-box">
                                ...
                                {talk.relatedHeritage ? (
                                    <div
                                        className="icon-border d-flex align-items-center gap-1 p-0 m-0 me-1"
                                        onClick={() =>
                                            navigate(
                                ...
                                <ReportButton
                                    reportedPostId={
                                        talk.content ? talk.talkId : talk.id
                                    }
